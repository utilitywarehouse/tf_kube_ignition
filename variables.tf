...
variable "cfssl_node_renew_timer" {
  description = "The systemd timestamp that triggers node certificate renewal (default to every Monday at 05:45)."
  default     = "Mon *-*-* 05:45:00"
}
